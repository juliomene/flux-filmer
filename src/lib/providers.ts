...
export const PROVIDERS: ProviderDef[] = [
  ...
  {
    id: "xai",
    label: "xAI Grok (via fal.ai)",
    supports: ["image", "video"],
    defaultImageModel: "fal-ai/xai/grok-imagine-image",
    defaultVideoModel: "fal-ai/xai/grok-imagine-video/text-to-video",
    imageHint: "ex.: fal-ai/xai/grok-imagine-image",
    videoHint: "ex.: fal-ai/xai/grok-imagine-video/text-to-video",
    apiKeyHelp: "fal_....",
