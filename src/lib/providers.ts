...
export const PROVIDERS: ProviderDef[] = [
  ...
  },
  {
    ...
    supports: ["image", "video"],
    defaultImageModel: "xai/grok-imagine-image",
    defaultVideoModel: "xai/grok-imagine-video/text-to-video",
    imageHint: "ex.: xai/grok-imagine-image",
    videoHint: "ex.: xai/grok-imagine-video/text-to-video",
    apiKeyHelp: "fal_....",
